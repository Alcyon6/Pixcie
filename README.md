...
Pixcie is a Python based image viewer with support for jpg, png, gif, bmp, and heif images. It can display metadata for jpg, heic files, and png files generated by Automatic1111. It can be operated with mouse or arrow keys.
